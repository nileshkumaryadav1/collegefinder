      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 24px; max-width: 600px; margin: auto;">
          ...
          <div style="text-align: center; font-size: 13px; color: #6c757d; margin-top: 16px;">
            Sent by <a href="https://collegefinder.vercel.app" style="color: #0d6efd; text-decoration: none;">College Finder</a>
          </div>
        </div>
      `,
    };
          ...
          <div style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 24px;">
              ...
              <div style="text-align: center; margin: 20px 0;">
                <a href="https://collegefinder.vercel.app" style="background-color: #0d6efd; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-size: 16px;">Visit College Finder</a>
              </div>
