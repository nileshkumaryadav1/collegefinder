...
export default function AdminPostsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 space-y-6">
      ...
      {/* ================= POSTS LIST ================= */}
      {posts.length > 0 && (
        <div className="bg-[var(--card)]/60 border-[var(--border)] border rounded-xl overflow-hidden divide-y">
          {posts.map((post, index) => (
            <div
              key={post._id}
              className="flex justify-between items-center p-4 hover:scale-101 transition"
            >
              {/* LEFT */}
