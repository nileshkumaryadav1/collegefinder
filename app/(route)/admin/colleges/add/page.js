...
//     const generated = formData.name.toLowerCase().trim().replace(/\s+/g, "-");
...
//       return updateAtPath(prev, path, [...arr, item]);
//     });
//   };
...
//         throw new Error(err.message || "Failed to add college");
//       }
...
//       router.push(`/admin/colleges/manage`); // redirect to manage page
//     } catch (err) {
...
//                 {activeTab === "seo" && (
//                   <SeoTab formData={formData} onChange={handleFieldChange} />
//                 )}
...
//                 onClick={() => removeFromArray("gallery", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//           Approved By (comma-separated editable list)
//         </label>
//         <div className="space-y-2">
...
//               <input
//                 value={v}
//                 onChange={(e) => setAtPath(`approvedBy.${i}`, e.target.value)}
//                 className="flex-1 border rounded p-2"
//               />
//               <button
//                 type="button"
//                 className="px-2 rounded bg-red-500 text-white"
//                 onClick={() => removeFromArray("approvedBy", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//               type="button"
//               className="px-3 py-1 rounded bg-blue-600 text-white"
//               onClick={() => pushToArray("approvedBy", "")}
//             >
//               Add Approved
//             </button>
//           </div>
...
//               <input
//                 value={v}
//                 onChange={(e) => setAtPath(`accreditedBy.${i}`, e.target.value)}
//                 className="flex-1 border rounded p-2"
//               />
//               <button
//                 type="button"
//                 className="px-2 rounded bg-red-500 text-white"
//                 onClick={() => removeFromArray("accreditedBy", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//               type="button"
//               className="px-3 py-1 rounded bg-blue-600 text-white"
//               onClick={() => pushToArray("accreditedBy", "")}
//             >
//               Add Accredited
//             </button>
//           </div>
...
//               <input
//                 value={v}
//                 onChange={(e) => setAtPath(`departments.${i}`, e.target.value)}
//                 className="flex-1 border rounded p-2"
//               />
//               <button
//                 type="button"
//                 className="px-2 rounded bg-red-500 text-white"
//                 onClick={() => removeFromArray("departments", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//               type="button"
//               className="px-3 py-1 rounded bg-blue-600 text-white"
//               onClick={() => pushToArray("departments", "")}
//             >
//               Add Department
//             </button>
//           </div>
...
//           onChange={(e) => setAtPath("admissionProcess", e.target.value)}
//           className="w-full border rounded p-2 h-24"
//         />
//       </div>
...
//                   {course.program} — {course.specialization || "Untitled"}
//                 </div>
//                 <div className="flex gap-2">
//                   <button
//                     className="px-2 py-1 rounded bg-red-500 text-white"
//                     onClick={() => removeFromArray("coursesOffered", idx)}
//                   >
//                     Remove
//                   </button>
//                 </div>
...
//                 <select
//                   value={course.program || "B.Tech"}
//                   onChange={(e) =>
//                     updateArrayItem("coursesOffered", idx, {
//                       ...course,
...
//                 />
//                 <input
//                   value={(course.entranceExams || []).join(", ")}
//                   placeholder="Entrance Exams (comma-separated)"
//                   onChange={(e) =>
//                     updateArrayItem("coursesOffered", idx, {
//                       ...course,
//                       entranceExams: e.target.value
//                         .split(",")
//                         .map((s) => s.trim()),
//                     })
//                   }
...
//                 <button
//                   className="px-2 py-1 rounded bg-red-500 text-white"
//                   onClick={() => removeFromArray("cutOff", idx)}
//                 >
//                   Remove
//                 </button>
//               </div>
...
//         />
//         <input
//           name="fees.scholarshipAvailable"
//           value={formData.fees?.scholarshipAvailable ? "true" : ""}
//           onChange={(e) =>
//             setAtPath("fees.scholarshipAvailable", e.target.value === "true")
//           }
//           placeholder="Scholarship Available? true/false"
//           className="border rounded p-2"
//         />
//       </div>
...
//       <div>
//         <label className="block text-sm font-medium mb-1">
//           Mode Of Payment (comma separated)
//         </label>
//         <input
//           value={(formData.fees?.modeOfPayment || []).join(", ")}
//           onChange={(e) =>
//             setAtPath(
//               "fees.modeOfPayment",
...
//           placeholder="Online, DD, Bank Transfer"
//         />
//       </div>
...
//                 value={s.name || ""}
//                 onChange={(e) =>
//                   setAtPath(`scholarships.${i}.name`, e.target.value)
//                 }
//                 className="border rounded p-1"
//                 placeholder="Name"
//               />
...
//                 value={s.eligibility || ""}
//                 onChange={(e) =>
//                   setAtPath(`scholarships.${i}.eligibility`, e.target.value)
//                 }
//                 className="border rounded p-1"
//                 placeholder="Eligibility"
//               />
...
//                 value={s.amount || ""}
//                 onChange={(e) =>
//                   setAtPath(`scholarships.${i}.amount`, e.target.value)
//                 }
//                 className="border rounded p-1"
//                 placeholder="Amount"
//               />
...
//                 value={s.link || ""}
//                 onChange={(e) =>
//                   setAtPath(`scholarships.${i}.link`, e.target.value)
//                 }
//                 className="border rounded p-1"
//                 placeholder="Link"
//               />
...
//                 className="flex-1 border rounded p-2"
//                 value={f}
//                 onChange={(e) => setAtPath(`facilities.${i}`, e.target.value)}
//               />
//               <button
//                 className="px-2 py-1 rounded bg-red-500 text-white"
//                 onClick={() => removeFromArray("facilities", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//           <button
//             className="px-3 py-1 rounded bg-blue-600 text-white"
//             onClick={() => pushToArray("facilities", "")}
//           >
//             Add Facility
//           </button>
//         </div>
...
//         />
//         <input
//           name="hostels.capacity"
//           value={formData.hostels?.capacity || ""}
//           onChange={onChange}
...
//             <input
//               type="checkbox"
//               checked={!!formData.hostels?.boys}
//               onChange={(e) => setAtPath("hostels.boys", e.target.checked)}
//             />
//             Boys
//           </label>
//           <label className="flex items-center gap-2">
//             <input
//               type="checkbox"
//               checked={!!formData.hostels?.girls}
//               onChange={(e) => setAtPath("hostels.girls", e.target.checked)}
//             />
//             Girls
//           </label>
//         </div>
...
//         <textarea
//           value={formData.hostels?.description || ""}
//           onChange={(e) => setAtPath("hostels.description", e.target.value)}
...
//     pushToArray("placements.BTech.yearwiseStats", {
//       year: new Date().getFullYear(),
//       highest: "",
//       average: "",
//       median: "",
...
//     pushToArray("placements.MTech.yearwiseStats", {
//       year: new Date().getFullYear(),
//       highest: "",
//       average: "",
//       median: "",
...
//       <div className="grid grid-cols-3 gap-3">
//         <input
//           value={formData.placements?.BTech?.highest || ""}
//           onChange={(e) =>
//             setAtPath("placements.BTech.highest", e.target.value)
//           }
//           placeholder="BTech Highest"
//           className="border rounded p-2"
//         />
//         <input
//           value={formData.placements?.BTech?.average || ""}
//           onChange={(e) =>
//             setAtPath("placements.BTech.average", e.target.value)
//           }
//           placeholder="BTech Average"
//           className="border rounded p-2"
//         />
//         <input
//           value={formData.placements?.BTech?.median || ""}
//           onChange={(e) => setAtPath("placements.BTech.median", e.target.value)}
//           placeholder="BTech Median"
//           className="border rounded p-2"
//         />
//       </div>
...
//           <div
//             key={i}
//             className="grid grid-cols-6 gap-2 items-center border rounded p-2 mt-2"
//           >
//             <input
//               value={s.year || ""}
//               onChange={(e) =>
//                 updateArrayItem("placements.BTech.yearwiseStats", i, {
//                   ...s,
//                   year: Number(e.target.value),
//                 })
//               }
...
//             />
//             <input
//               value={s.placedStudents || ""}
//               onChange={(e) =>
//                 updateArrayItem("placements.BTech.yearwiseStats", i, {
//                   ...s,
//                   placedStudents: Number(e.target.value),
//                 })
//               }
//               className="border rounded p-1"
//             />
...
//               className="px-2 py-1 rounded bg-red-500 text-white"
//               onClick={() =>
//                 removeFromArray("placements.BTech.yearwiseStats", i)
//               }
//             >
//               Remove
//             </button>
...
//         <div className="grid grid-cols-3 gap-3">
//           <input
//             value={formData.placements?.MTech?.highest || ""}
//             onChange={(e) =>
//               setAtPath("placements.MTech.highest", e.target.value)
//             }
//             placeholder="MTech Highest"
//             className="border rounded p-2"
//           />
//           <input
//             value={formData.placements?.MTech?.average || ""}
//             onChange={(e) =>
//               setAtPath("placements.MTech.average", e.target.value)
//             }
//             placeholder="MTech Average"
//             className="border rounded p-2"
//           />
//           <input
//             value={formData.placements?.MTech?.median || ""}
//             onChange={(e) =>
//               setAtPath("placements.MTech.median", e.target.value)
//             }
//             placeholder="MTech Median"
//             className="border rounded p-2"
//           />
//         </div>
...
//                 value={s.year || ""}
//                 onChange={(e) =>
//                   updateArrayItem("placements.MTech.yearwiseStats", i, {
//                     ...s,
//                     year: Number(e.target.value),
//                   })
//                 }
...
//                 className="px-2 py-1 rounded bg-red-500 text-white"
//                 onClick={() =>
//                   removeFromArray("placements.MTech.yearwiseStats", i)
//                 }
//               >
//                 Remove
//               </button>
...
//       <div className="mt-4">
//         <input
//           value={formData.placements?.placementCellContact || ""}
//           onChange={(e) =>
//             setAtPath("placements.placementCellContact", e.target.value)
//           }
...
//                 value={r.source || ""}
//                 onChange={(e) =>
//                   setAtPath(`otherRankings.${i}.source`, e.target.value)
//                 }
//                 placeholder="Source"
//                 className="border rounded p-1"
//               />
...
//                 value={r.year || ""}
//                 onChange={(e) =>
//                   setAtPath(`otherRankings.${i}.year`, e.target.value)
//                 }
//                 placeholder="Year"
//                 className="border rounded p-1"
//               />
...
//                 value={r.rank || ""}
//                 onChange={(e) =>
//                   setAtPath(`otherRankings.${i}.rank`, e.target.value)
//                 }
//                 placeholder="Rank"
//                 className="border rounded p-1"
//               />
//               <button
//                 className="px-2 py-1 rounded bg-red-500 text-white"
//                 onClick={() => removeFromArray("otherRankings", i)}
//               >
//                 Remove
//               </button>
//             </div>
...
//               className="px-3 py-1 rounded bg-blue-600 text-white"
//               onClick={() =>
//                 pushToArray("otherRankings", { source: "", year: "", rank: "" })
//               }
//             >
//               Add Ranking
//             </button>
...
//             type="checkbox"
//             checked={!!formData.verified}
//             onChange={(e) => setAtPath("verified", e.target.checked)}
//           />
//           Verified
//         </label>
//         <label className="flex items-center gap-2 mt-2">
...
//             type="checkbox"
//             checked={!!formData.approved}
//             onChange={(e) => setAtPath("approved", e.target.checked)}
//           />
//           Approved
//         </label>
//       </div>
