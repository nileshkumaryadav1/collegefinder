...
export default function SponsorUsPage() {
  ...
  return (
    <>
      <Head>
        <title>Become a Sponsor | College Finder</title>
        <meta name="description" content="Partner with us to bring your brand to a wide audience at our upcoming events." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Become a Sponsor | College Finder" />
        <meta property="og:description" content="Partner with us to bring your brand to a wide audience at our upcoming events." />
      </Head>

      <div className="min-h-screen px-4 md:px-10 lg:px-20 py-8 bg-white text-gray-800">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-blue-600 mb-2">Become a Sponsor</h1>
